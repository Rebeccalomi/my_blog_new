<template>
  <div class="me-view-comment-item">
    <div class="me-view-comment-author">
      <a class="">
        <img class="me-view-picture" :src="comment.author.avatar" v-if="comment.author.avatar"></img>
        <img class="me-view-picture" src="https://img.rebecana.top/image-20220411160751809.png" v-if="!comment.author.avatar"></img>
      </a>
    ...
    <div>
      ...
      <div class="me-view-comment-tools">
        ...
        <!--</a>-->
        <el-button  size="mini" type="primary" class="me-button" @click="showComment(-1,comment.author)">
          评论
        </el-button>
      </div>
      ...
      <div class="me-reply-list">
        <div class="me-reply-item" v-for="c in comment.childrens" :key="c.id">
          <div style="font-size: 14px">
            ...
            <span style="color:#000;font-weight:50;">{{c.content}}</span>
          </div>
          <div class="me-view-meta">
        ...
        <div class="me-view-comment-write" v-show="commentShow">
          <template>
            ...
            <el-button  size="small" type="primary" class="me-button" style="margin-left: 8px;margin-bottom:5px;" @click="publishComment()">评论</el-button>
        </template>
        </div>
...
export default {
  ...
  methods: {
    ...
    publishComment() {
      ...
      publishComment(that.reply, this.$store.state.token)
        .then((data) => {
          if (data.success) {
            that.$message({
              type: "success",
